...
public interface IFinVoucherEntriesService 
{
    ...
    /**
     * 按科目汇总指定期间内的凭证分录金额（排除结账模版生成的凭证）
     * @return 包含 subjectId, debitTotal, creditTotal 的 Map，无记录返回 null
     */
    Map<String, Object> sumBySubjectAndPeriod(String groupid, Date startDate, Date endDate, String subjectId);
