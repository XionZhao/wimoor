...
public class FinAccountingSubjectsController extends BaseController
{
 ...
 /**
    ...
    public Result upload(@PathVariable("groupId") String groupId, MultipartFile file,
                         @RequestParam(value = "importType", defaultValue = "increment") String importType)
    {
        try (InputStream inputStream = file.getInputStream()) {
            int result = finAccountingSubjectsService.importSubjects(inputStream, groupId, importType);
