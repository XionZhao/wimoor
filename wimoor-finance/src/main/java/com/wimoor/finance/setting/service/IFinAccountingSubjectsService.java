...
public interface IFinAccountingSubjectsService 
{
     ...
     * 根据父科目编码查询子科目列表
     */
    List<FinAccountingSubjects> selectByParentCode(String groupid, String parentCode);
     ...
     */
    int importSubjects(InputStream inputStream, String groupId, String importType) throws IOException;
     ...
     * 根据科目ID获取科目编码
     */
    String getSubjectCodeById(String groupid, String subjectId);
}