...
public interface IFinGeneralLedgerService 
{
     ...
     */
    Map<String, Object> getLatestBalanceBeforePeriod(String groupid, String subjectCode, String period);

    /**
     * 查询所有科目在指定期间之前最近的记录（带前推查找）
     */
    List<Map<String, Object>> getAllSubjectBalanceWithFallback(String groupid, String period);
