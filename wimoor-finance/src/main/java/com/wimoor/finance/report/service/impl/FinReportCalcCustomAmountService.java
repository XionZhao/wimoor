    ...
    private BigDecimal getItemAmount(String groupid, String period, String itemCode) {
        ...
        try {
            ...
            switch (itemCode) {
                ...
                // ==================== 所有者权益类科目（小企业会计准则 3xxx 编码） ====================
                case "EQUITY_CAPITAL":
                    // 实收资本
                    return calculateItemAmount(groupid, period, "3001");

                case "EQUITY_RESERVE":
                    // 资本公积
                    return calculateItemAmount(groupid, period, "3002");

                case "EQUITY_SURPLUS":
                    // 盈余公积
                    return calculateItemAmount(groupid, period, "3101");

                case "EQUITY_RETAINED":
                    // 未分配利润
                    return calculateItemAmount(groupid, period, "3104");
