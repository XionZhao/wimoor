...
public class FinReportMappingRulesServiceImpl implements IFinReportMappingRulesService
{
    ...
    private List<FinReportMappingRules> createDefaultRules(String groupid)
    {
        ...
        // 所有者权益（小企业会计准则 3xxx 编码）
        rules.add(createRule(groupid, "BALANCE_SHEET", "EQUITY_CAPITAL", "实收资本", "PREFIX", "3001", null, "ADD", 3, 2, 1, 10, "3001-实收资本"));
        rules.add(createRule(groupid, "BALANCE_SHEET", "EQUITY_RESERVE", "资本公积", "PREFIX", "3002", null, "ADD", 3, 2, 1, 10, "3002-资本公积"));
        rules.add(createRule(groupid, "BALANCE_SHEET", "EQUITY_SURPLUS", "盈余公积", "PREFIX", "3101", null, "ADD", 3, 2, 1, 10, "3101-盈余公积"));
        rules.add(createRule(groupid, "BALANCE_SHEET", "EQUITY_RETAINED", "未分配利润", "PREFIX", "3104", null, "ADD", 3, 2, 1, 10, "3104-未分配利润"));
        ...
        // ========== 所有者权益变动表规则（小企业会计准则 3xxx 编码） ==========
        // 期初余额
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_CAPITAL_PRIOR", "实收资本期初", "PREFIX", "3001", null, "ADD", 3, 2, 0, 10, "实收资本期初余额"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_RESERVE_CAPITAL_PRIOR", "资本公积期初", "PREFIX", "3002", null, "ADD", 3, 2, 0, 10, "资本公积期初余额"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_RESERVE_SURPLUS_PRIOR", "盈余公积期初", "PREFIX", "3101", null, "ADD", 3, 2, 0, 10, "盈余公积期初余额"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_RETAINED_PRIOR", "未分配利润期初", "PREFIX", "3104", null, "ADD", 3, 2, 0, 10, "未分配利润期初余额"));

        // 期末余额
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_CAPITAL_ENDING", "实收资本期末", "PREFIX", "3001", null, "ADD", 3, 2, 0, 10, "实收资本期末余额"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_RESERVE_CAPITAL_ENDING", "资本公积期末", "PREFIX", "3002", null, "ADD", 3, 2, 0, 10, "资本公积期末余额"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_RESERVE_SURPLUS_ENDING", "盈余公积期末", "PREFIX", "3101", null, "ADD", 3, 2, 0, 10, "盈余公积期末余额"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "BALANCE_RETAINED_ENDING", "未分配利润期末", "PREFIX", "3104", null, "ADD", 3, 2, 0, 10, "未分配利润期末余额"));

        // 本年增减变动
        rules.add(createRule(groupid, "EQUITY_CHANGE", "CHANGE_CAPITAL_IN", "所有者投入资本", "PREFIX", "3001", null, "ADD", 3, 2, 0, 10, "实收资本增加表示所有者投入"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "CHANGE_CAPITAL_REDUCE", "所有者减少资本", "PREFIX", "3001", null, "SUBTRACT", 3, 1, 0, 10, "实收资本减少表示所有者减少"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "CHANGE_SURPLUS_EXTRACT", "提取盈余公积", "PREFIX", "3101", null, "ADD", 3, 2, 0, 10, "盈余公积增加表示提取"));
        rules.add(createRule(groupid, "EQUITY_CHANGE", "CHANGE_DIVIDEND", "对所有者（或股东）的分配", "PREFIX", "3104", null, "SUBTRACT", 3, 1, 0, 10, "未分配利润减少表示分配"));
