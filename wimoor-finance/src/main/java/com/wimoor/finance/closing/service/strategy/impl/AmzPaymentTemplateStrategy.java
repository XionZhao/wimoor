...
public class AmzPaymentTemplateStrategy implements IFinClosingTemplateStrategy {
    ...
    public void initTemplateItemInventoryCredit(FinClosingTemplate template){
        String summary="亚马逊平台收入-FBA库存补贴";
    ...
    public void initTemplateItemPromotional(FinClosingTemplate template){
        ...
        String amountField="Promotional rebates";
        String subjectCode=null;
        switch (template.getCountry().toUpperCase()) {
            case "CA":
                subjectCode = "50010601";
                break;
            case "US":
                subjectCode = "50010602";
                break;
            case "FR":
            case "NL":
            case "DE":
            ...
            case "IT":
            case "EG":
                subjectCode = "50010603";
                break;
            case "UK":
                subjectCode = "50010604";
                break;
            case "PL":
                subjectCode = "50010605";
                break;
            case "SE":
                subjectCode = "50010606";
                break;
            case "TR":
                subjectCode = "50010607";
                break;
            case "MX":
                subjectCode = "50010608";
                break;
        }
        saveTemplateItem( template, subjectCode, summary, amountField,2);
    }
    public void initTemplateItemPromotionalRefunds(FinClosingTemplate template){
        ...
        String amountField="Promotional rebate refunds";
        String subjectCode=null;
        switch (template.getCountry().toUpperCase()) {
            case "CA":
                subjectCode = "50010601";
    ...
    public void initTemplateItemTotal(FinClosingTemplate template){
        ...
        String amountField="Total Income Expenses Tax-Transfers to bank account-Failed transfers to bank account";
        String subjectCode=null;
        switch (template.getCountry().toUpperCase()) {
            case "CA":
                subjectCode = "11220101";
