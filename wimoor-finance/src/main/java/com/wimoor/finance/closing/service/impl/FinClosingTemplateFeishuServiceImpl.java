...
public class FinClosingTemplateFeishuServiceImpl implements IFinClosingTemplateFeishuService 
{
     ...
     */
    @Override
    public int insertOrUpdateByTemplateid(FinClosingTemplateFeishu finClosingTemplateFeishu)
    {
        return finClosingTemplateFeishuMapper.insertOrUpdateByTemplateid(finClosingTemplateFeishu);
    }
