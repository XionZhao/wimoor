...
public class FinClosingTemplateFeishuController extends BaseController
{
    ...
    /**
     * 新增或修改结算飞书格同步（存在则更新，不存在则插入）
     */
    @PostMapping("/insertOrUpdate")
    public Result insertOrUpdate(@RequestBody FinClosingTemplateFeishu finClosingTemplateFeishu)
    {
        return toResult(finClosingTemplateFeishuService.insertOrUpdateByTemplateid(finClosingTemplateFeishu));
    }
