...
import com.wimoor.finance.closing.domain.DeletedVoucherInfo;
import com.wimoor.finance.closing.domain.PreReverseCheckResult;
...
public class ReverseClosingService {
    ...
    private void deleteProfitTransferVouchers(String groupid, String period, ReverseClosingResult result) {
        ...
        for (FinVouchers voucher : transferVouchers) {
            ...
            // 删除结账模板凭证关联记录
            finClosingTemplateVouchersService.deleteByVoucherId(voucher.getVoucherId().toString());
