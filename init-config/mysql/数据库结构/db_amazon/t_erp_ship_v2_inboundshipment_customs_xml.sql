...
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundshipment_customs_xml` (
  ...
  `apply_company` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '当前所选申报公司名称',
  `all_company` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '电商企业名称下拉列表的所有公司（逗号分隔）',
