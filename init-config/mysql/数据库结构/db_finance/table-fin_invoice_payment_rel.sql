...
-- 导出  表 db_finance.fin_invoice_payment_rel 结构
CREATE TABLE IF NOT EXISTS `fin_invoice_payment_rel` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_inv_pay` (`invoice_id`,`payment_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='发票与付款关联表';
