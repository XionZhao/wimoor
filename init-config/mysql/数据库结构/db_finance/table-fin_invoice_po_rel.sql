...
-- 导出  表 db_finance.fin_invoice_po_rel 结构
CREATE TABLE IF NOT EXISTS `fin_invoice_po_rel` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_inv_po` (`invoice_id`,`purchase_order_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='发票与采购订单关联表';
